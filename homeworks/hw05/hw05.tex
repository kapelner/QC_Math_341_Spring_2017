...
Reading is still \textit{required}. For this homework set, review the Geometric-Beta model, the Poisson-Gamma model, Normal-Normal model and the posterior predictive distributions in each case.
