...
\title{MATH 341 / 650 Spring 2017 Homework \#5}

\author{Professor Adam Kapelner} %STUDENTS: write your name here

\iftoggle{professormode}{
\date{Due 6PM under my office door (KY604), Friday, March 31, 2017 \\ \vspace{0.5cm} \small (this document last updated \today ~at \currenttime)}
}
...
Reading is still \textit{required}. For this homework set, review the Geometric-Beta model, the Poisson-Gamma model, the Exponential-Gamma model and the posterior predictive distributions in the first two cases. Then, study the basics of the Normal-Normal model. Also, review credible regions and Bayesian Hypothesis Tests.
